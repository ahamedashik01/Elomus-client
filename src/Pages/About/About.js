                        ...
                        <Container className="p-5">
                            <Row className="5">
                                <Col sm={12} md={6} className="text-start my-5">
                                    ...
                                    <button className="btn btn-dark rounded-pill px-3 text-white mt-5">Make A order Now</button>
                                </Col>
                        ...
                        <Col md={6} sm={12} className="my-auto py-5 my-5">
                            <Accordion defaultActiveKey="0" flush>
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header > <h6> How do I make an order? </h6></Accordion.Header>
                                    <Accordion.Body className="text-start">
                                        <p>To make order for Consultation with our Consultants who sit in our Out-patient Departments, please call our hotline 10666 from any phone anywhere in the country or you can call in our order Desk landline 02 22 22 62 466 you can call in these numbers to make order for any investigations or procedures as well.</p>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="1">
                                    <Accordion.Header> <h6> Do you have Consultants available for 24 hours? </h6></Accordion.Header>
                                    <Accordion.Body className="text-start">
                                        <p>In our agency, to provide Consultation services, our Consultants are available from 7am till 9pm on weekdays (Saturday to Thursday); of course the time varies from Consultant to Consultant; in Friday as well we have few Consultants sitting their OPD. To know details as per your choice of Consultant, please call in our  hotline number 10666 from any phone anywhere in the country or you can call in our order Desk landline 02 22 22 62 466</p>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="2">
                                    ...
                                    <Accordion.Body className="text-start">
                                        <p>For enquiries within the Agency during odd hours and on holidays, please call our Duty Manager at 01914001399. For any enquiry about any clinical condition.</p>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="3">
                                    ...
                                    <Accordion.Body className="text-start">
                                        <p>First please check whether you have GOP (Guarantee of Payment) letter issued by your Insurance Company to avail the specific service that you have come for (either in OPD or IPD). Also check whether your insurance company has any formal agreement with United Agency, being enlisted makes the job faster. As a note of authentification, during the time of service, you need to show your Health Card and GOP issued by your Insurance Company.</p>
                                    </Accordion.Body>
                                </Accordion.Item>
                            </Accordion>
                        </Col>
