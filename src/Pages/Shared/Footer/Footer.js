            ...
            <div className="footer py-3 text-start">
                <Container>
                    <Row className="pt-4">
                        <Col sm={12} md={6}>
                            <div className="px-5">
                                <h1 className="text-white mb-4">EL<i className="fab fa-watchman-monitoring  text-primaru"></i>mus</h1>
                        ...
                        <Col sm={12} md={3}>
                            <div className="text-start departments">
                                ...
                                <ul className="list-unstyled mt-3 text-white text-start">
                                    ...
                                    <li className="mb-2">Xoimi</li>
                                    <li className="mb-2">Rorelx</li>
                                    <li className="mb-2">Viet</li>
                                    <li className="mb-2">AirXtr</li>
                                </ul>
                            </div>
                        </Col>
                        <Col sm={12} md={3}>
                    ...
                    <p className="mt-5 text-center text-white">Copyright © 2020 Elomus All Rights Reserved.</p>
                </Container>
            </div >
        </>
    );
